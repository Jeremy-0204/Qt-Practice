#include "superlumbs8401.h"
#include "QDebug"
#include <string>

SuperlumBS8401::SuperlumBS8401(QObject *parent)
    : QObject(parent)
{
...
bool SuperlumBS8401::SetSweepMode(ELaserSweepMode SweepMode)
{
...
bool SuperlumBS8401::SetSingleWaveLength(const float WaveLength)
{
...
bool SuperlumBS8401::SendPacket(const char* Packet)
{
...
bool SuperlumBS8401::connectToPort(const QString &portName, int baudRate, int flowControl, int parity, int dataBits, int stopBits)
{
